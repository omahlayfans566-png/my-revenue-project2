...
const testimonials = [
  ...
  },
  {
    ...
    text: "We matched on DateClone and instantly connected. Six months later we got engaged. I couldn't be happier.",
    rating: 5,
  },
  {
    ...
    text: "I never believed online dating could be genuine until I found my soulmate here. DateClone changed my life.",
    rating: 5,
  },
  {
...
const Testimonials = () => (
  <div className="page-wrapper">
    ...
    <section className="testimonials" style={{ marginTop: 0 }}>
      {/* Stats strip */}
      <div className="stats">
      ...
      <div className="testimonial-heading">
        <span className="badge">❤️ VERIFIED LOVE STORIES</span>
        <h2>
          Real Connections.
          <span> Real Love.</span>
        </h2>
        <p>
          Thousands of African singles have found meaningful
          relationships through DateClone.
        </p>
      </div>
        ...
        {testimonials.map((item, i) => (
          <div className="testimonial-card" key={i}>
            ...
            <div className="testimonial-content">
              ...
              <div className="verified">✓ Verified Couple</div>
